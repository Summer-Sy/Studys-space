...
int main()
{
    ...
    int stat[3];
    printf("-------------------------防疫信息查询系统-------------------------\n\n");
    if(mysql_real_connect(&mysql, "localhost", "root", "123456", "experiment2", 3306, NULL, 0))
    {
        ...
        while(scanf("%d", &choose1))
        {
            switch(choose1)
            {
                        ...
                        while(scanf("%d", &choose2))
                        {
                            switch(choose2)
                            {
                                case 1:
                                        ...
                                        strcat(select_query,"select * from basic,data where basic.ID = data.ID and basic.ID = '");
                                ...
                                case 2:
                                        ...
                                        strcat(select_query,"select * from basic,data where basic.ID = data.ID and basic.name = '");
                                        strcat(select_query,str1);
                                        strcat(select_query,"' and data.date = '2020-");
                                        strcat(select_query,monc);
                                        strcat(select_query,"-");
                ...
                case 2:
                        ...
                        strcat(select_query,"select * from data where 是否确诊 = '是' and date = '2020-");
                        strcat(select_query,monc);
                        strcat(select_query,"-");
                        strcat(select_query,dayc);
                        strcat(select_query,"'");
                        ...
                        memset(select_query, 0 ,sizeof(select_query));
                        strcat(select_query,"select * from data where 是否疑似 = '是' and date = '2020-");
                        strcat(select_query,monc);
                        strcat(select_query,"-");
                        strcat(select_query,dayc);
                        strcat(select_query,"'");
                       // printf("%s",select_query);
                        ...
                        memset(select_query, 0 ,sizeof(select_query));
                        strcat(select_query,"select * from data where 是否接触 = '是' and date = '2020-");
                        strcat(select_query,monc);
                        strcat(select_query,"-");
                        strcat(select_query,dayc);
                        strcat(select_query,"'");
